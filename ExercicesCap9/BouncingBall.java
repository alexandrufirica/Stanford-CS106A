...
public class BouncingBall extends GraphicsProgram {
	...
	/**Inital X and Y location of ball */
	...
	/**Determine if collision with floor, update velocities and location as appropiate */
	private void checkForCollision(){
		//determine id vall has dropped below the floor
		if ( ball.getY() > getHeight() - DIAM_BALL){
			//change ball's Y velocity to now bounce upwards
			yVel = - yVel * BOUNCE_REDUCE;
			
			//assume bouce will move ball an amount above the floor equal to the
			//amount it would have dropped below the floor.
