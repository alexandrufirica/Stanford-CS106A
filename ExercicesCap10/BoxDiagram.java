	...
	/* Initializes the program */
		...
		//Create the controll bar on bottom of the window.
		...
		// Add box with given name on the center of the window.
		...
		private void removeContents(){
			...
			contents.clear(); // clear all entries in HashMap
		}
		...
		// Called on mouse press to record the coordinates of click
		public void mousePressed(MouseEvent e){
			last = new GPoint( e.getPoint());
			currentObject = getElementAt(last);	
		}
		// Called on mouse to reposision the object
		...
		// Called mouse to send the object in front 
